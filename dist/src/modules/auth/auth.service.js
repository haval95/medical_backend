...
export const startPhoneAuth = async (input) => {
...
export const verifyPhoneAuth = async (input) => {
    ...
    return {
        token: generateAccessToken(buildAuthPayload(user.id, user.phoneNumber, user.role, user.permissions, user.status)),
