import { AccessReviewStatus, AppointmentStatus, BackupOperationStatus, BackupOperationType, ConsentType, DiscountStatus, GovernanceRequestStatus, GovernanceRequestType, PatientGender, Permission, Role, ServiceRequestStatus, SecurityIncidentSeverity, SecurityIncidentStatus, UserStatus, } from '@prisma/client';
import { z } from 'zod';
...
const slotLengthSchema = z
    ...
    .refine((value) => value % 5 === 0, 'Slot length must use 5-minute increments, such as 10, 15, 20, 25, 30, or 60 minutes.');
const bufferMinutesSchema = z
    ...
    .refine((value) => value % 5 === 0, 'Blocked/buffer time must use 5-minute increments, such as 0, 5, 10, 15, or 30 minutes.');
