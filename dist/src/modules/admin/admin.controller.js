...
export const requests = asyncHandler(async (_req, res) => {
    const data = await getAdminRequests();
    res.json(ApiResponse.success('Admin requests retrieved successfully', data));
});
export const requestDirectory = asyncHandler(async (req, res) => {
...
export const requestById = asyncHandler(async (req, res) => {
...
export const doctorDirectory = asyncHandler(async (req, res) => {
...
export const doctorById = asyncHandler(async (req, res) => {
...
export const createDoctorScheduleTemplate = asyncHandler(async (req, res) => {
...
export const createDoctorUnavailability = asyncHandler(async (req, res) => {
...
export const patients = asyncHandler(async (_req, res) => {
    const data = await listAdminPatients();
    res.json(ApiResponse.success('Admin patients retrieved successfully', data));
});
export const patientDirectory = asyncHandler(async (req, res) => {
...
export const patientById = asyncHandler(async (req, res) => {
...
export const appointmentDirectory = asyncHandler(async (req, res) => {
    const filters = adminListAppointmentsSchema.parse(req.query);
...
export const appointmentById = asyncHandler(async (req, res) => {
...
export const reviewDirectory = asyncHandler(async (req, res) => {
...
export const reportTable = asyncHandler(async (req, res) => {
...
export const complianceOverview = asyncHandler(async (_req, res) => {
...
export const retentionRules = asyncHandler(async (_req, res) => {
    const data = await listRetentionRules();
    res.json(ApiResponse.success('Retention rules retrieved successfully', data));
});
export const createRetentionRuleRecord = asyncHandler(async (req, res) => {
...
export const runRetentionRuleRecord = asyncHandler(async (req, res) => {
...
export const securityIncidents = asyncHandler(async (_req, res) => {
    const data = await listSecurityIncidents();
    res.json(ApiResponse.success('Security incidents retrieved successfully', data));
});
export const createSecurityIncidentRecord = asyncHandler(async (req, res) => {
...
export const updateSecurityIncidentRecord = asyncHandler(async (req, res) => {
...
export const accessReviews = asyncHandler(async (_req, res) => {
    const data = await listAccessReviews();
    res.json(ApiResponse.success('Access reviews retrieved successfully', data));
});
export const createAccessReviewRecord = asyncHandler(async (req, res) => {
...
export const updateAccessReviewRecord = asyncHandler(async (req, res) => {
...
export const dataGovernanceRequests = asyncHandler(async (_req, res) => {
...
export const createDataGovernanceRequestRecord = asyncHandler(async (req, res) => {
...
export const processDataGovernanceRequestRecord = asyncHandler(async (req, res) => {
...
export const backupOperations = asyncHandler(async (_req, res) => {
    const data = await listBackupOperations();
    res.json(ApiResponse.success('Backup operations retrieved successfully', data));
});
export const createBackupOperationRecord = asyncHandler(async (req, res) => {
...
export const updateBackupOperationRecord = asyncHandler(async (req, res) => {
...
export const notificationQueue = asyncHandler(async (req, res) => {
...
export const processNotificationQueueRecord = asyncHandler(async (req, res) => {
