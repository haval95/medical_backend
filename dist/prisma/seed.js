import { AccessReviewStatus, AppointmentStatus, BackupOperationStatus, BackupOperationType, ConsentType, DiscountStatus, DiscountType, GovernanceRequestStatus, GovernanceRequestType, NotificationDeliveryStatus, NotificationType, PatientGender, Permission, PointsTransactionType, PrismaClient, ReferralEventType, Role, ScheduleSlotStatus, SecurityIncidentSeverity, SecurityIncidentStatus, ServiceRequestStatus, ServiceRequestType, UserStatus, } from '@prisma/client';
