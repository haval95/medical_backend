...
router.get(
  ...
  adminController.onboardingSteps
);
router.post(
  '/onboarding-steps',
  authorizePermissions(Permission.ADMIN_MANAGE),
  adminController.createOnboardingStepRecord
);
router.patch(
  '/onboarding-steps/:stepId',
  authorizePermissions(Permission.ADMIN_MANAGE),
  adminController.updateOnboardingStepRecord
);
router.delete(
  '/onboarding-steps/:stepId',
  authorizePermissions(Permission.ADMIN_MANAGE),
  adminController.deleteOnboardingStepRecord
);
router.post(
  '/uploads/onboarding-image',
  authorizePermissions(Permission.ADMIN_MANAGE),
  adminController.uploadOnboardingImageAsset
);
